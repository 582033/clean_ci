...
class MY_Controller extends CI_Controller {
	...
	/**
	  ...
	  */
		...
		if($output == 'null') header("HTTP/1.1 404");
		$this->output->set_output($output);
	} //}}}
	function _check_request_method($method){	//检测请求方式{{{
		$method = strtoupper($method);
		if($_SERVER['REQUEST_METHOD'] != $method) show_error_text('405', HTTP_STATUS_CODE_405);
	}	//}}}
}
